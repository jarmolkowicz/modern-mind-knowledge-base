...
The ability to recognize deep structural similarities between different domains — transferring knowledge from a familiar situation to a novel one based on shared relational patterns, not surface features.
